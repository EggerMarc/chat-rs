...
You can also reach for streaming on purpose with `.with_streamed_response()`. This requires the provider to implement `StreamProvider`, and it switches the builder into a streamed chat.
